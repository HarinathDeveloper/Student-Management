...
<body>
    ...
    <h2 style="color:green;">Student Registration Successful</h2>
    <div class="col-12 col-md-8 student-login-form">
      <form action="StudentRegistrationAccept" method="post">
        <input type="text" name="student_id" placeholder="Student Registration Number" class="form-registration-input" required autocomplete="off">
        <br>
        ...
        <div class="form-registration-input">
          ...
          <label><input type="radio" name="gender" value="other" id="o">Others</label>
        </div>
        ...
        <input type="text" name="passout_year" placeholder="passout_year" class="duration" required>
        <br>
